...
#elif ENABLED(MKS_SPI_SH1106_OLED)
  U8GLIB_SH1106_128X64_2X u8g(DOGLCD_SCK, DOGLCD_MOSI, DOGLCD_CS, DOGLCD_A0, LCD_PINS_RS ); // SW SPI Com: SCK = 23, MOSI = 17, CS = 16, A0 = 25, RS = 27
